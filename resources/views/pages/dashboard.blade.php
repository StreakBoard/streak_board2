        ...
        <div class="team-dropdown-div w-clearfix">
                ...
                <div data-delay="0" class="light-dropdown-style w-dropdown">
                    ...
                    <nav class="dropdown-list teams w-dropdown-list forpadding">
										<a href="user/dashboard/MzQ3" class="nav-dark wide w-dropdown-link active">wpcoders</a>
								</nav>
                </div>
            </div>
        </div>
			...
			<div class="grid-box-3">
				<div class="task-list-div full-list">
					...
					<div class="block-head div-line flex">
							...
							<div class="heading-3 no-top-padding _0">Wpcoders's Members (<span id="tMember">1</span>)</div>
															<a href="{{url('/invite')}}" class="invite-button w-button">+ Invite member</a>
					...
					<div class="member-grid">
						<div class="member-holder">
							...
							<div class="right-streak-content">
								<div class="username-text wider">{{ Auth::user()->name }}</div>
